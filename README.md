...
### ✔️ 머신러닝(LightGBM, RandomFroest, LinearRegression, Lasso)을 활용한 수입 (외제) 중고차 가격 예측 프로젝트입니다.  
...
# 🔍 참고 자료
- 데이터
[데이콘 Basic 자동차 가격 예측 AI 경진대회] ([링크](https://dacon.io/competitions/official/236114/overview/description))
